...
\addplot+[only marks, mark=*, mark options={fill=green}] coordinates {
    ((0.0)^2, {sin(deg(10*(0.0)^2))})
    ((0.1)^2, {sin(deg(10*(0.1)^2))})
    ((0.2)^2, {sin(deg(10*(0.2)^2))})
    ((0.3)^2, {sin(deg(10*(0.3)^2))})
    ((0.4)^2, {sin(deg(10*(0.4)^2))})
    ((0.5)^2, {sin(deg(10*(0.5)^2))})
    ((0.6)^2, {sin(deg(10*(0.6)^2))})
    ((0.7)^2, {sin(deg(10*(0.7)^2))})
    ((0.8)^2, {sin(deg(10*(0.8)^2))})
    ((0.9)^2, {sin(deg(10*(0.9)^2))})
    ((1.0)^2, {sin(deg(10*(1.0)^2))})
};
