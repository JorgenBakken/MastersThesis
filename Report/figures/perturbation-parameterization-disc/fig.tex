...
\addplot+[mark=*, mark options={fill=green}] coordinates {
    (0.0, {sin(deg(10*0.0))})
    (0.1, {sin(deg(10*(0.1 + 0.03)))})
    (0.2, {sin(deg(10*(0.2 - 0.03)))})
    (0.3, {sin(deg(10*(0.3 + 0.03)))})
    (0.4, {sin(deg(10*(0.4 - 0.03)))})
    (0.5, {sin(deg(10*(0.5 + 0.03)))})
    (0.6, {sin(deg(10*(0.6 - 0.03)))})
    (0.7, {sin(deg(10*(0.7 + 0.03)))})
    (0.8, {sin(deg(10*(0.8 - 0.03)))})
    (0.9, {sin(deg(10*(0.9 + 0.03)))})
    (1.0, {sin(deg(10*1.0))})
};
